...
#Train parameters
experiment= "DISC_segmentation_trim_augmentation_extract_4848_1to3_sgd_unet2_diceloss2"
...
model.compile(optimizer=sgd, loss=log_dice_loss ,metrics=['accuracy', mean_IOU_gpu, dice_metric])
